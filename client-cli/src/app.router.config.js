  ...
  configure() {
	  var appRouterConfig = function(config) {
	    ...
	    config.map([
	      ...
	      { route: 'customer',      moduleId: 'modules/customer/customer',       			nav: true, 	title: 'CRM', 				auth: true },
				{ route: 'customer2',     moduleId: 'modules/customer/customer2',      			nav: true, 	title: 'CRM Custom', auth: true },				
